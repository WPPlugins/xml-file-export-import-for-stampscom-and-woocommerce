...
class WF_OrderImpExpStampsXML_System_Status_Tools {
	...
	public function tools( $tools ) {
		$tools['delete_trashed_orders'] = array(
			'name'		=> __( 'Delete Trashed Orders','wf_order_import_export_stamps_xml'),
			'button'	=> __( 'Delete  Trashed Orders','wf_order_import_export_stamps_xml' ),
			'desc'		=> __( 'This tool will delete all  Trashed Orders.', 'wf_order_import_export_stamps_xml' ),
			'callback'  => array( $this, 'delete_trashed_orders' )
		);
		$tools['delete_all_orders'] = array(
			'name'		=> __( 'Delete Orders','wf_order_import_export_stamps_xml'),
			'button'	=> __( 'Delete ALL Orders','wf_order_import_export_stamps_xml' ),
			'desc'		=> __( 'This tool will delete all orders allowing you to start fresh.', 'wf_order_import_export_stamps_xml' ),
	...
	public function delete_trashed_orders() {
		...
		echo '<div class="updated"><p>' . sprintf( __( '%d Orders Deleted', 'wf_order_import_export_stamps_xml' ), ( $result ) ) . '</p></div>';
	}
